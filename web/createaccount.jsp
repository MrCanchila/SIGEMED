<%-- 
    ...
    Created on : 30/03/2015, 07:24:40 PM
    Author     : julieth
--%>
...
<html>
    <head>
        <title>SIGEMED .::. Create account</title>
                    ...
                    <div class="col-md-6">
                        <form name="frmcrearregistro" action="Sigemed" method="POST">
                            <div class="form-group">
                                <label for="txtNombre1">Names</label>
                            ...
                            <div class="form-group">
                                <label for="txtApellido1">Surname</label>
                                <div class="form-inline">
                            ...
                            <div class="form-group">
                                <label for="txtDocumento">Identification</label>
                                <div class="form-inline">
                            ...
                            <button type="submit" class="btn btn-primary" name="RegistrarP" >Create account</button>
                        </form>
                    </div>
                </div>
            </div>
